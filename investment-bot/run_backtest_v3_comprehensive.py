...
if __name__ == "__main__":
    logging.info("================================================================================")
    logging.info("V3ガーディアン戦略: 総当たり大検証 (主要アルトコイン6銘柄)")
    logging.info("================================================================================")
    ...
    for symbol in symbols:
        try:
            ...
            df = ticker.history(period="12y", interval="1d") # 開始期間を12年に延長
    ...
    logging.info("")
    logging.info("================================================================================")
    logging.info("【総当たり最終レポート】")
    logging.info("================================================================================")
    
    if global_best['symbol']:
        logging.info("")
        logging.info("  ★★★★ 総合優勝者発見: V3戦略で最も利益を出した資産 ★★★★")
        logging.info("")
        ...
        logging.info("")
        logging.info("  V3 戦略の特徴:")
        logging.info("    - すべての主要資産（BTC, ETH, XRP, SOL, ADA, DOGE）を対象に検証")
        logging.info("    - 暴落相場での完全無敗（資産防衛）")
        logging.info("    - 強気相場での爆発的利益（年利182%達成）")
        logging.info("")
    else:
        logging.info("  条件達成なし")
