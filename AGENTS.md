...
When doing coding tasks (file modifications, refactoring, feature implementation):

- **Use Claude Code** on this machine for all coding work
- To use Claude Code:
  - Use the `coding-agent` skill
  - Run `claude code` CLI in the background
  - Claude Code works within workspace repositories
- For complex modifications or large-scale refactoring, use Claude Code first
- Claude Code provides better IDE integration and context for coding tasks
